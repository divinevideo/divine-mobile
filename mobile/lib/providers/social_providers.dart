// ABOUTME: Foundation, DM-retry, and collaborator Riverpod providers split from app_providers.dart
  ...
  service.onDatabaseCleanup =
      ({
        ...
        if (deleteUserData && userPubkey != null) {
          ...
          // switch keeps them: the relay publishes the held ones regardless,
          // and the rest wait here for the account to sign back in. A
