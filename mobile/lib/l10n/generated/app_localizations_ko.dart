...
class AppLocalizationsKo extends AppLocalizations {
  ...
  @override
  String get inboxActionReportVanishedAccount => '이 계정 신고';

  @override
  String get inboxActionBlockVanishedAccount => '이 계정 차단';

  @override
  String get inboxActionUnblockVanishedAccount => '이 계정 차단 해제';

  @override
  String get inboxReportedVanishedAccount => '이 계정을 신고했어요';

  @override
  String get inboxBlockedVanishedAccount => '이 계정을 차단했어요';
  ...
  @override
  String get dmDeleteRefusedMessage => '모두에게서 삭제하지 못했어요.';

  @override
  String get dmDeleteRefusedDetails => '일부 사람에게는 이 메시지가 아직 보일 수 있어요.';
  ...
  @override
  String get videoEditorCaptionsPresetSaved => '저장됨';

  @override
  String get videoEditorCaptionsSavedStylesTitle => '저장한 스타일';

  @override
  String get videoEditorCaptionsSavedStylesSaveCurrent => '현재 스타일 저장';

  @override
  String get videoEditorCaptionsSavedStylesEmpty =>
      '아직 저장된 스타일이 없어요. 커스텀 스타일을 만든 다음 여기에 저장하면 다음 영상에서도 같은 모습으로 쓸 수 있어요.';

  @override
  String get videoEditorCaptionsSavedStylesLoadFailed => '저장한 스타일을 불러오지 못했어요.';

  @override
  String get videoEditorCaptionsSavedStyleNameLabel => '스타일 이름';

  @override
  String get videoEditorCaptionsSavedStyleSaveTitle => '스타일 저장';

  @override
  String get videoEditorCaptionsSavedStyleSaveAction => '저장';

  @override
  String get videoEditorCaptionsSavedStyleRenameTitle => '스타일 이름 바꾸기';

  @override
  String get videoEditorCaptionsSavedStyleRenameAction => '이름 바꾸기';
  ...
  String videoEditorCaptionsSavedStyleReorderSemanticLabel(String name) {
    return '$name 순서를 바꾸려면 드래그하세요';
  }

  @override
  String videoEditorCaptionsSavedStyleSaved(String name) {
    return '“$name”(으)로 저장했어요';
  }

  @override
  String get videoEditorCaptionsSavedStyleSaveFailed => '스타일을 저장하지 못했어요.';

  @override
  String get videoEditorTitleStylesLabel => '스타일';

  @override
  String get videoEditorTitleStylesButtonSemanticLabel => '이 텍스트에 쓸 저장된 스타일';

  @override
  String get videoEditorTitleSavedStylesEmpty =>
      '아직 저장된 스타일이 없어요. 텍스트를 원하는 모습으로 꾸민 다음 여기에 저장하면 다음 영상에서도 같은 모습으로 쓸 수 있어요.';

  @override
  String get videoEditorTitleSavedStyleDeleteConfirmMessage =>
      '이 스타일을 이미 쓰고 있는 텍스트는 그대로 유지돼요.';
  ...
  @override
  String get crosspostingBenefitTitle => '루프를 어디든 데려가요';

  @override
  String get crosspostingBenefitBody =>
      'Divine에 한 번 올리면 Instagram으로 바로 공유돼요. 사람들은 이미 그곳에 있어요 — 만나러 가요. 보낸 루프마다 작은 링크가 함께 가서, 다음 크리에이터도 우리를 찾을 수 있어요.';
  ...
  @override
  String get crosspostingAutoTitle => '한 번만 설정하세요';

  @override
  String crosspostingAutoBody(String platform) {
    return '새로 올리는 루프는 자동으로 $platform에 전송돼요 — 추가 탭 없이요. 이걸 켠 뒤에 공개한 루프에만 적용돼요.';
  }
