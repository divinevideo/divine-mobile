...
class AppLocalizationsUr extends AppLocalizations {
  ...
  @override
  String get postPublishConfirmationShare => 'شیئر';
  ...
  @override
  String get dmDeleteRefusedMessage => 'سب کے لیے حذف نہیں ہو سکا۔';

  @override
  String get dmDeleteRefusedDetails => 'کچھ لوگ اب بھی یہ پیغام دیکھ سکتے ہیں۔';
  ...
  String get supportPublicSubmissionMessage =>
      'آپ یہاں جو کچھ لکھیں وہ ہماری اوپن سورس GitHub ریپوزٹری میں پوسٹ کیا جائے گا تاکہ ڈویلپرز اس پر کام کر سکیں، اور اس کے ساتھ ڈیوائس کی بنیادی معلومات، جیسے آپ کے فون کا ماڈل اور ایپ کا ورژن، بھی پوسٹ کی جائیں گی۔ آپ کا اکاؤنٹ اور ایپ کے تشخیصی لاگز ہماری سپورٹ ٹیم کے پاس نجی رہتے ہیں۔ کوئی بھی ایسی چیز شامل نہ کریں جسے آپ عوامی نہ کرنا چاہیں۔';
  ...
  @override
  String get soundUploadSupportedFormats => 'AAC، M4A، MP3 یا WAV';
  ...
  String get savedSoundDeleteConfirmMessage =>
      'یہ آپ کا ہے، اس لیے یہ سب کے لیے Divine کی ساؤنڈ فہرستوں اور کریڈٹس سے ہٹ جائے گا۔ آڈیو فائل خود فی الحال اپنے لنک پر رہے گی، اور جو ویڈیوز پہلے سے اسے استعمال کر رہی ہیں ان کی آواز برقرار رہے گی۔';
