...
class AppLocalizationsUr extends AppLocalizations {
  ...
  String get supportPublicSubmissionMessage =>
      'آپ یہاں جو کچھ لکھیں، وہ آپ کے فون کے ماڈل اور ایپ کے ورژن جیسی ڈیوائس کی بنیادی معلومات کے ساتھ GitHub پر پوسٹ کیا جائے گا تاکہ ٹیم ہماری عوامی ریپوزٹریز میں مسائل پر کام کر سکے۔ آپ کا اکاؤنٹ اور ایپ کے تشخیصی لاگز ہماری سپورٹ ٹیم کے پاس نجی رہتے ہیں۔ کوئی بھی ایسی چیز شامل نہ کریں جسے آپ عوامی نہ کرنا چاہیں۔';
