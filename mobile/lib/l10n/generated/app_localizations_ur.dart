...
class AppLocalizationsUr extends AppLocalizations {
  ...
  String get supportPublicSubmissionMessage =>
      'آپ یہاں جو کچھ لکھیں گے وہ ہمارے اوپن سورس GitHub ریپوزٹری میں پوسٹ کیا جائے گا تاکہ ڈویلپرز اس پر کام کر سکیں، اور ساتھ میں آلے کی بنیادی معلومات، جیسے آپ کے فون کا ماڈل اور ایپ کا ورژن، بھی۔ آپ کا اکاؤنٹ اور ایپ کے تشخیصی لاگز ہماری سپورٹ ٹیم کے پاس نجی رہتے ہیں۔ کوئی بھی ایسی چیز شامل نہ کریں جسے آپ عوامی نہیں کرنا چاہتے۔';
