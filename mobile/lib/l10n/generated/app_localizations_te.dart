...
class AppLocalizationsTe extends AppLocalizations {
  ...
  @override
  String get supportPublicSubmissionTitle => 'పబ్లిక్ GitHub పోస్ట్';

  @override
  String get supportPublicSubmissionMessage =>
      'మీరు ఇక్కడ రాసేది, మీ ఫోన్ మోడల్, యాప్ వెర్షన్ వంటి ప్రాథమిక పరికర సమాచారంతో పాటు, GitHubలో పోస్ట్ చేయబడుతుంది, తద్వారా బృందం మా పబ్లిక్ రిపోజిటరీలలోని సమస్యలపై పని చేయగలదు. మీ ఖాతా మరియు యాప్ డయాగ్నస్టిక్ లాగ్‌లు మా సపోర్ట్ బృందం వద్ద ప్రైవేట్‌గా ఉంటాయి. పబ్లిక్‌గా ఉండకూడదని మీరు కోరుకునే దేనినీ చేర్చకండి.';
  ...
  String get videoEditorLibraryImportProgressLabel =>
      'ఒక్క క్షణం, మేము మీ ఫోటోలను క్లిప్‌గా మారుస్తున్నాము';
  ...
  String get videoEditorLibraryImportStillsMissing =>
      'ఆ ఫోటోలు కనిపించలేదు. మీ టైమ్‌లైన్ మారలేదు.';
