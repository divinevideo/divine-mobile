...
class AppLocalizationsTe extends AppLocalizations {
  ...
  String get supporterAutoRenewNotice =>
      'మీరు రద్దు చేసే వరకు ప్లాన్‌లు చూపిన ధరకు ఆటోమేటిక్‌గా పునరుద్ధరించబడతాయి. తదుపరి పునరుద్ధరణకు కనీసం 24 గంటల ముందు App Store లేదా Google Play సబ్‌స్క్రిప్షన్ సెట్టింగ్‌లలో మీరు ఎప్పుడైనా రద్దు చేయవచ్చు.';
