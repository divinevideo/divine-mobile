...
class AppLocalizationsTe extends AppLocalizations {
  ...
  String get supportPublicSubmissionMessage =>
      'మీరు ఇక్కడ రాసేది GitHubలోని మా ఓపెన్-సోర్స్ రిపోజిటరీకి పోస్ట్ చేయబడుతుంది, తద్వారా డెవలపర్‌లు దానిపై పని చేయగలరు; దానితో పాటు మీ ఫోన్ మోడల్, యాప్ వెర్షన్ వంటి ప్రాథమిక పరికర సమాచారం కూడా పోస్ట్ చేయబడుతుంది. మీ ఖాతా మరియు యాప్ డయాగ్నస్టిక్ లాగ్‌లు మా సపోర్ట్ బృందం వద్ద ప్రైవేట్‌గా ఉంటాయి. పబ్లిక్‌గా ఉండకూడదని మీరు కోరుకునే దేనినీ చేర్చకండి.';
