...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String get shareMenuDeleteCleanupFailed =>
      'تم حذف الفيديو. قد تظل بعض النسخ متاحة.';
  ...
  String get supportPublicSubmissionMessage =>
      'يُنشر كل ما يُكتب هنا على GitHub، مع معلومات أساسية عن الجهاز مثل طراز الهاتف وإصدار التطبيق، ليتمكن الفريق من العمل على المشكلات في مستودعاتنا العامة. أما الحساب وسجلات التشخيص الخاصة بالتطبيق فتبقى خاصة لدى فريق الدعم لدينا. يُرجى عدم تضمين أي شيء لا يُراد نشره علنًا.';
  ...
  String get videoEditorLibraryImportStillsMissing =>
      'تعذّر العثور على هذه الصور. الجدول الزمني كما هو دون تغيير.';
  ...
  @override
  String get updateGentleBanner => 'تحديث جديد متاح للاطّلاع ←';
