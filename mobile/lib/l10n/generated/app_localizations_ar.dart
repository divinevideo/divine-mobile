...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String get supportPublicSubmissionMessage =>
      'كل ما يُكتب هنا يُنشر في مستودعنا مفتوح المصدر على GitHub ليتمكن المطورون من العمل عليه، مع معلومات أساسية عن الجهاز مثل طراز الهاتف وإصدار التطبيق. أما الحساب وسجلات التشخيص الخاصة بالتطبيق فتبقى خاصة لدى فريق الدعم لدينا. يُرجى عدم تضمين أي شيء لا يُراد نشره علنًا.';
