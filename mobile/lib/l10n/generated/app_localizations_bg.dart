...
class AppLocalizationsBg extends AppLocalizations {
  ...
  String get supportPublicSubmissionMessage =>
      'Това, което напишеш тук, ще бъде публикувано в нашето хранилище с отворен код в GitHub, за да могат разработчиците да го поемат, заедно с основна информация за устройството, като модела на телефона и версията на приложението. Профилът ти и диагностичните логове на приложението остават поверителни при нашия екип за поддръжка. Не включвай нищо, което не искаш да е публично.';
