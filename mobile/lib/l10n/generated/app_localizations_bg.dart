...
class AppLocalizationsBg extends AppLocalizations {
  ...
  String get supportPublicSubmissionMessage =>
      'Това, което напишеш тук, заедно с основна информация за устройството, като модела на телефона и версията на приложението, ще бъде публикувано в GitHub, за да може екипът да работи по проблемите в нашите публични хранилища. Акаунтът ти и диагностичните логове на приложението остават поверителни при нашия екип за поддръжка. Не включвай нищо, което не искаш да е публично.';
