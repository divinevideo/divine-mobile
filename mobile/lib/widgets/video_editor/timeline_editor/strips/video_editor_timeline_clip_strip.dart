...
import 'package:openvine/widgets/video_editor/timeline_editor/strips/video_editor_timeline_transition_buttons.dart';
...
class _VideoEditorTimelineClipStripState
  ...
  Widget build(BuildContext context) {
    ...
    final loopSlotWidth = _orderedClips.isEmpty
        ? 0.0
        : TimelineTransitionButtonsLayer.hitWidth / 2;
              ...
              children: [
                ...
                if (!shouldAnimate &&
                  ...
                  if (_orderedClips.length >= 2)
                    TimelineTransitionButtonsLayer(
                      clips: _orderedClips,
                      layout: layout,
                    ),
                  if (seamRegionWidth > 0)
                    TimelineLoopSeamRegion(
