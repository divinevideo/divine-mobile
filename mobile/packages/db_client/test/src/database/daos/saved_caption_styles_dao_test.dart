// ABOUTME: Unit tests for SavedCaptionStylesDao CRUD, ordering and
// ABOUTME: per-account isolation of the saved video-editor caption styles.
...
void main() {
  ...
  late SavedCaptionStylesDao dao;
  ...
  setUp(() async {
    final tempDir = Directory.systemTemp.createTempSync(
      'saved_caption_styles_dao_',
    );
    tempDbPath = '${tempDir.path}/test.db';
    database = AppDatabase.test(NativeDatabase(File(tempDbPath)));
    dao = database.savedCaptionStylesDao;
  });
