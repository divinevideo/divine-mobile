...
class PendingReports extends Table
    with TableInfo<PendingReports, PendingReportsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  PendingReports(this.attachedDatabase, [this._alias]);
  ...
  @override
  PendingReportsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return PendingReportsData(
  ...
  @override
  PendingReports createAlias(String alias) {
    return PendingReports(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const ['PRIMARY KEY(report_id)'];
  @override
  bool get dontWriteConstraints => true;
}

class PendingReportsData extends DataClass
    implements Insertable<PendingReportsData> {
  ...
  factory PendingReportsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  PendingReportsData copyWithCompanion(PendingReportsCompanion data) {
    return PendingReportsData(
  ...
  @override
  String toString() {
    return (StringBuffer('PendingReportsData(')
...
class PendingReportsCompanion extends UpdateCompanion<PendingReportsData> {
  ...
  PendingReportsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       zendeskStatus = Value(zendeskStatus),
       createdAt = Value(createdAt);
  static Insertable<PendingReportsData> custom({
...
class SavedCaptionStyles extends Table
    with TableInfo<SavedCaptionStyles, SavedCaptionStylesData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SavedCaptionStyles(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'saved_caption_styles';
  @override
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  SavedCaptionStylesData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return SavedCaptionStylesData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  SavedCaptionStyles createAlias(String alias) {
    return SavedCaptionStyles(attachedDatabase, alias);
  }
...
class SavedCaptionStylesData extends DataClass
    implements Insertable<SavedCaptionStylesData> {
  final String id;
  final String name;
  final String style;
  final int orderIndex;
  ...
  SavedCaptionStylesCompanion toCompanion(bool nullToAbsent) {
    return SavedCaptionStylesCompanion(
      id: Value(id),
      name: Value(name),
      style: Value(style),
      orderIndex: Value(orderIndex),
  ...
  factory SavedCaptionStylesData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  SavedCaptionStylesData copyWith({
    String? id,
    String? name,
    String? style,
    int? orderIndex,
  ...
  SavedCaptionStylesData copyWithCompanion(SavedCaptionStylesCompanion data) {
    return SavedCaptionStylesData(
      id: data.id.present ? data.id.value : this.id,
      name: data.name.present ? data.name.value : this.name,
  ...
  @override
  String toString() {
    return (StringBuffer('SavedCaptionStylesData(')
          ..write('id: $id, ')
          ..write('name: $name, ')
          ..write('style: $style, ')
          ..write('orderIndex: $orderIndex, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is SavedCaptionStylesData &&
          other.id == this.id &&
          other.name == this.name &&
...
class SavedCaptionStylesCompanion
    extends UpdateCompanion<SavedCaptionStylesData> {
  final Value<String> id;
  final Value<String> name;
  ...
  final Value<String?> ownerPubkey;
  final Value<int> rowid;
  const SavedCaptionStylesCompanion({
    this.id = const Value.absent(),
    this.name = const Value.absent(),
  ...
  SavedCaptionStylesCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       style = Value(style),
       createdAt = Value(createdAt);
  static Insertable<SavedCaptionStylesData> custom({
    Expression<String>? id,
    Expression<String>? name,
  ...
  SavedCaptionStylesCompanion copyWith({
    Value<String>? id,
    Value<String>? name,
    Value<String>? style,
    Value<int>? orderIndex,
  ...
  @override
  String toString() {
    return (StringBuffer('SavedCaptionStylesCompanion(')
          ..write('id: $id, ')
          ..write('name: $name, ')
          ..write('style: $style, ')
          ..write('orderIndex: $orderIndex, ')
...
class SavedTitleStyles extends Table
    with TableInfo<SavedTitleStyles, SavedTitleStylesData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SavedTitleStyles(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  SavedTitleStylesData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return SavedTitleStylesData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  SavedTitleStyles createAlias(String alias) {
    return SavedTitleStyles(attachedDatabase, alias);
  }
...
class SavedTitleStylesData extends DataClass
    implements Insertable<SavedTitleStylesData> {
  final String id;
  final String name;
  final String style;
  final int orderIndex;
  ...
  factory SavedTitleStylesData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  SavedTitleStylesData copyWithCompanion(SavedTitleStylesCompanion data) {
    return SavedTitleStylesData(
      id: data.id.present ? data.id.value : this.id,
      name: data.name.present ? data.name.value : this.name,
      style: data.style.present ? data.style.value : this.style,
  ...
  @override
  String toString() {
    return (StringBuffer('SavedTitleStylesData(')
          ..write('id: $id, ')
          ..write('name: $name, ')
          ..write('style: $style, ')
          ..write('orderIndex: $orderIndex, ')
...
class SavedTitleStylesCompanion extends UpdateCompanion<SavedTitleStylesData> {
  final Value<String> id;
  final Value<String> name;
  final Value<String> style;
  final Value<int> orderIndex;
  ...
  SavedTitleStylesCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       style = Value(style),
       createdAt = Value(createdAt);
  static Insertable<SavedTitleStylesData> custom({
    Expression<String>? id,
    Expression<String>? name,
    Expression<String>? style,
    Expression<int>? orderIndex,
...
class ScheduledPosts extends Table
    with TableInfo<ScheduledPosts, ScheduledPostsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ScheduledPosts(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> eventId = GeneratedColumn<String>(
    'event_id',
    aliasedName,
    false,
  ...
  Set<GeneratedColumn> get $primaryKey => {eventId};
  @override
  ScheduledPostsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  ScheduledPosts createAlias(String alias) {
    return ScheduledPosts(attachedDatabase, alias);
  }
...
class ScheduledPostsData extends DataClass
    implements Insertable<ScheduledPostsData> {
  final String eventId;
  final String ownerPubkey;
  final String draftId;
  ...
  factory ScheduledPostsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  ScheduledPostsData copyWithCompanion(ScheduledPostsCompanion data) {
    return ScheduledPostsData(
      eventId: data.eventId.present ? data.eventId.value : this.eventId,
      ownerPubkey: data.ownerPubkey.present
          ? data.ownerPubkey.value
  ...
  @override
  String toString() {
    return (StringBuffer('ScheduledPostsData(')
          ..write('eventId: $eventId, ')
          ..write('ownerPubkey: $ownerPubkey, ')
          ..write('draftId: $draftId, ')
...
class ScheduledPostsCompanion extends UpdateCompanion<ScheduledPostsData> {
  final Value<String> eventId;
  final Value<String> ownerPubkey;
  final Value<String> draftId;
  ...
  ScheduledPostsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       status = Value(status),
       createdAt = Value(createdAt);
  static Insertable<ScheduledPostsData> custom({
    Expression<String>? eventId,
    Expression<String>? ownerPubkey,
    Expression<String>? draftId,
...
class DatabaseAtV18 extends GeneratedDatabase {
  ...
  late final PendingReports pendingReports = PendingReports(this);
  ...
  late final SavedCaptionStyles savedCaptionStyles = SavedCaptionStyles(this);
  late final SavedTitleStyles savedTitleStyles = SavedTitleStyles(this);
  late final ScheduledPosts scheduledPosts = ScheduledPosts(this);
