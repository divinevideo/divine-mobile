// ABOUTME: How a one-shot query ended, and the per-query bookkeeping RelayPool
// ABOUTME: keeps to say so: each relay's answer, cap signals, NIP-67 hints.
...
/// [conclude] when the query ends. Not part of the SDK's API.
