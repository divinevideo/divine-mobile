// ABOUTME: Tests for SavedCaptionStyleRepository against an in-memory Drift
...
void main() {
  ...
  group(SavedCaptionStyleRepository, () {
    ...
    SavedCaptionStyleRepository repositoryFor(String? owner) =>
    ...
    group('getStyles', () {
      test('skips a row whose payload no longer decodes', () async {
        ...
        await database.savedCaptionStylesDao.upsertStyle(
          id: 'corrupt',
          name: 'Bad',
