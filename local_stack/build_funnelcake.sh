...
echo ""
echo "That mixing is not just a version skew you can retry your way out of. Once"
echo "one side applies a migration the other side does not carry, the next"
echo "migrate run bails with \"applied migration ... is missing from the migration"
echo "directory\" and stays that way until the overrides match again — or until"
echo "you discard Funnelcake's database:"
echo ""
echo "    docker compose -f local_stack/docker-compose.yml down"
